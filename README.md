...
[Agora](http://www.agora.io) Interactive Broadcasting SDK is available for iOS and Android, supporting RTMP and HLS. It enables bit rate auto adjustment to adapt to broadcasting under different bandwidth.
